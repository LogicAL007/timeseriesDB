...
df = pd.read_csv("dataa/PRSA_Data_Aotizhongxin_20130301-20170228.csv", encoding= "iso-8859-1" )
...
client = influxdb_client.InfluxDBClient(
   ...
   token='p-2LmxwAhgWgTD92PF1CUyLnectB3vUqmYrmjnpjjP3nFZR_PI8qDBXudnEXt-b1jAY5v4Fsb0BeW6_1ZqdYzQ==',
   org='my-org'
)
